...
╠🌹࿆͜͡➢SCRIPT NAME:🌀ᬊ͜͡Slavik-Dependenciesᬊ͜͡2020
╰───────╮•╭───────────────────╯
𖡨❯╅╾┽┄╼❮ཤ𖢘ཥ❯╾┄┾╼╆❮𖡨𖡨❯╅╾┽┄╾┄┾╼╆❮𖡨"
sleep 1
echo -e $r"╭───────╯•╰───────────────────╮"

echo -e $g1" 𖡨 ᴀʟʟᴀʜ ᶠⁱʳˢᵗ 𖡨"
sleep 0.5
echo -e $r" █▀▀▀█ █░░░ █▀▀█ █░░▒█ ▀█▀ █░▄▀"
echo " ▀▀▀▄▄ █░░░ █▄▄█ ▒█▒█░ ░█░ █▀▄░-IUN"
echo " █▄▄▄█ █▄▄█ █░▒█ ░▀▄▀░ ▄█▄ █░▒█"
...
echo -e $cyan" 45)  NODEJS"
echo -e $cyan" 46)  MARIADB"
echo -e $cyan" 47)  NPM"
echo -e $green" 00) OTHER tools"
sleep 1
echo -e $r"╰───────╮•╭───────────────────╯"
sleep 0.5
echo -e $g"𖡨❯╅╾┽┄╼❮ཤ𖢘ཥ❯╾┄┾╼╆❮𖡨𖡨❯╅╾┽┄╾┄┾╼╆❮𖡨"$green
read -p "{[@Welcome]}
[ ˢᴸᴬᵛᴵᴷ🔵]============>" act;
...
then
clear
echo -e $green" instaling NPM @slavik "
sleep 1
npm start
...
echo -e $green" instaling mariadb @slavik "
sleep 1
pkg install mariadb
echo -e $green" COMPLETE "
fi
...
echo -e $green" instaling nodejs @slavik "
sleep 1
pkg install nodejs
echo -e $green" COMPLETE "
fi
